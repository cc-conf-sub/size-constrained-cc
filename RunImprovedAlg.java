...
public class RunImprovedAlg {
    ...
    public static void main(String args[]) {
        ...
        int[] k_vals = {2, 3, 4, 5, 6, 7, 8, 9, 10}; //, 15, 20, 25, 30, 35, 40, 45, 50};
        ...
        System.out.println("LS times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(blendTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("LS scores: ");
        for (int i = 0; i < ROUNDS; i++)
        ...
        System.out.println("Average LS time: " + blendTimeTotal / ((double) ROUNDS));
        System.out.println();
        System.out.println("Average Improved score: " + pivotScoreTotal / ((double) ROUNDS));
	    System.out.println("Average LS score: " + blendScoreTotal / ((double) ROUNDS));

        System.out.println();
        System.out.println("Average Improved num clusters: " + pivotNumClusters / ((double) ROUNDS));
        System.out.println("Average LS num clusters: " + blendNumClusters / ((double) ROUNDS));

        System.out.println();
        System.out.println("Average Improved max cluster size: " + largestPivotCluster / ((double) ROUNDS));
        System.out.println("Average LS max cluster size: " + largestBlendCluster / ((double) ROUNDS));
