...
public class RunPMAlg {
    
    public static void main(String args[]) {
        String data_set = "cor_captchas";
        String delimiter = "\\s"; 
        ...
        ArrayList<ArrayList<Integer>> pivot_result = RoundingPM(var_array);
        ...
        ArrayList<ArrayList<Integer>> blend_result = DNode.local_search_network_size_limit(copy1, prob_matrix, K, -1); // RoundingImproved(var_array, K);
        ...
        System.out.println("PM times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(pivotTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("PM scores: ");
        for (int i = 0; i < ROUNDS; i++)
        ...
        System.out.println("Average PM time: " + pivotTimeTotal / ((double) ROUNDS));
        System.out.println("Average Improved time: " + blendTimeTotal / ((double) ROUNDS));
        System.out.println();
        System.out.println("Average PM score: " + pivotScoreTotal / ((double) ROUNDS));
	    System.out.println("Average Improved score: " + blendScoreTotal / ((double) ROUNDS));

        System.out.println();
        System.out.println("Average PM num clusters: " + pivotNumClusters / ((double) ROUNDS));
        System.out.println("Average Improved num clusters: " + blendNumClusters / ((double) ROUNDS));

        System.out.println();
        System.out.println("Average PM max cluster size: " + largestPivotCluster / ((double) ROUNDS));
