...
public class RunTimedBlend {
	...
	ArrayList<ArrayList<Integer>> cur_clustering = null; // PKwik.k_pivotBlend(prob_matrix, k);
	long initialTime = System.currentTimeMillis() - initial;
        ...
        ArrayList<ArrayList<Integer>> pivot_result = PKwik.k_pivotBlend(prob_matrix, k); //KLocalSearch.k_local_search_network_timed(prob_matrix, cur_clustering, k, pivotStart, twoMinuteLimit);
