...
public class RunTimedLS {
    ...
    public static void main(String args[]) {
        ...
        int[] k_vals = {60000, 120000, 180000, 240000, 300000, 360000, 420000, 480000, 540000, 600000};  // , 110000, 120000, 130000, 140000, 150000};
	...
	long tenMinuteLimit = 600000;
	    ...
	    ArrayList<ArrayList<Integer>> cur_clustering = null; // KLocalSearch.initializeClustering(prob_matrix.size(), k);
	...
	*/
        ...
        ArrayList<ArrayList<Integer>> pivot_result = KLocalSearch.initializeClustering(prob_matrix.size(), k);
 // KLocalSearch.k_local_search_network_timed(prob_matrix, copy1, k, pivotStart, twoMinuteLimit);
        ...
        ArrayList<ArrayList<Integer>> fill_result = KLocalSearch.k_local_search_network_timed(prob_matrix, copy1, k, fillStart, twoMinuteLimit);
 // cur_clustering; //KLocalSearch.k_local_search_network_timed(prob_matrix, copy2, k, fillStart, fiveMinuteLimit);
        ...
        ArrayList<ArrayList<Integer>> rand_result = pivot_result; // KLocalSearch.k_local_search_network_timed(prob_matrix, copy3, k, randStart, tenMinuteLimit);
