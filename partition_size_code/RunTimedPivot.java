...
public class RunTimedPivot {
	...
	long tenMinuteLimit = 600000;
        ...
        for (int j = 0; j < ROUNDS; j++) {
            ...
            ArrayList<ArrayList<Integer>> cur_clustering = null; // PKwik.k_pivot(prob_matrix, k);
        ...
        ArrayList<ArrayList<Integer>> pivot_result = PKwik.k_pivot(prob_matrix, k); // KLocalSearch.k_local_search_network_timed(prob_matrix, copy1, k, pivotStart, twoMinuteLimit);
