...
public class RunTimedVote {
	...
	long minuteLimit = 60000;
        ...
        for (int j = 0; j < ROUNDS; j++) {
            ...
            ArrayList<ArrayList<Integer>> cur_clustering = null; // DNode.k_random_node_network(prob_matrix, k);
        ...
        ArrayList<ArrayList<Integer>> pivot_result = DNode.k_random_node_network(prob_matrix, k); //KLocalSearch.k_local_search_network_timed(prob_matrix, cur_clustering, k, pivotStart, twoMinuteLimit);
        ...
        ArrayList<ArrayList<Integer>> fill_result = pivot_result; // KLocalSearch.k_local_search_network_timed(prob_matrix, copy1, k, fillStart, twoMinuteLimit);
        ...
        ArrayList<ArrayList<Integer>> rand_result = pivot_result; //  KLocalSearch.k_local_search_network_timed(prob_matrix, copy2, k, randStart, tenMinuteLimit);
